...
import { AlertCircle, UserPlus, Mail, Lock, User, Sparkles } from "lucide-react";
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-red-950 flex items-center justify-center py-12 px-4">
        ...
        <Card className="relative w-full max-w-md border-none bg-white/5 backdrop-blur-sm shadow-2xl">
          <CardHeader className="space-y-1">
            <CardTitle className="text-3xl font-bold text-white">Registration Closed</CardTitle>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-center text-sm text-gray-400">
              ...
              <Link href="/auth/signin" className="text-red-400 hover:text-red-300 font-semibold transition">
                Sign in here
              </Link>
            </div>
          </CardContent>
