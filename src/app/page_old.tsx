...
import { Wrench, Award, Clock, ArrowRight, Star, Sparkles, Shield, Users, TrendingUp, CheckCircle2, Zap, Target, Heart } from "lucide-react"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>Browse our completed restoration projects</p>
                  </TooltipContent>
                </Tooltip>
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>Learn from our restoration experiences</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </div>
          ...
          <div className="text-center mt-12">
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p>Explore our complete restoration gallery</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
